    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='../static/img/index.png', null=True, upload_to='profile/group/%y/%m/%d/')),
                ('link', models.CharField(default='hbqJ1qxOUJv9csxbq4NA', max_length=50, unique=True)),
